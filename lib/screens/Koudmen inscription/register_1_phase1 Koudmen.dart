...
class Register1KoudmenPage extends StatefulWidget {
  final String userId;
  Register1KoudmenPage({Key? key, required this.userId}) : super(key: key);
...
class _Register1KoudmenPageState extends State<Register1KoudmenPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Données formulaire
    late String nom, prenom, structure, email, confirmEmail;
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      // Email confirmation
                                      CustomTextField(
                                        labelText: "Confirmation e-mail",
                                        onSaved: (String value) {
                                          confirmEmail = value;
                                        },
                                        errorMessage:
                                            "Merci de remplir ce champ",
                                        hintText: "Confirmation e-mail",
                                        icon: Icon(
                                          Icons.email,
                                          color: formIconCol,
                                        ),
