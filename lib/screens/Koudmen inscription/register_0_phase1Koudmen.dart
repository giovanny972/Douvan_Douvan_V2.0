...
import 'package:koudmen/screens/Koudmen%20inscription/register_1_phase1%20Koudmen.dart';
import 'package:koudmen/size_config.dart';
import 'package:firebase_auth/firebase_auth.dart';

class Register0KoudmenPage extends StatefulWidget {
  const Register0KoudmenPage({Key? key}) : super(key: key);

  @override
  State<Register0KoudmenPage> createState() => _Register0KoudmenPageState();
}

class _Register0KoudmenPageState extends State<Register0KoudmenPage> {
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  Register1KoudmenPage(userId: userId),
                            ),
                          );
                        },
